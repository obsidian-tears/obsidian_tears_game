...
function _BuyItem(shopId, itemId, qty, objectName) {
 window.dispatchReactUnityEvent("BuyItem", shopId, Pointer_stringify(itemId), qty, Pointer_stringify(objectName));
}

function _DefeatMonster(monsterId, objectName) {
 window.dispatchReactUnityEvent("DefeatMonster", monsterId, Pointer_stringify(objectName));
}
...
var dynCall_iiiiifffffi = Module["dynCall_iiiiifffffi"] = createExportWrapper("dynCall_iiiiifffffi");
...
var dynCall_viiiffiifii = Module["dynCall_viiiffiifii"] = createExportWrapper("dynCall_viiiffiifii");
