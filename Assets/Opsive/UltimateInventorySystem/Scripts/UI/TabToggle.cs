...
namespace Opsive.UltimateInventorySystem.UI
{
    ...
    public class TabToggle : MonoBehaviour, IPointerClickHandler
    {
        ...
        [Tooltip("An event when the tab is toggled on.")]
        [SerializeField] protected UnityEvent m_OnToggleOn;
        [Tooltip("An event when the tab is toggled off.")]
        [SerializeField] protected UnityEvent m_OnToggleOff;
