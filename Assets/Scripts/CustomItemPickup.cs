...
namespace Opsive.UltimateInventorySystem.DropsAndPickups
{
    ...
    public class CustomItemPickup : ItemPickup
    {
        public new event Action OnStateChange;
        // [Tooltip("The item collection where the items should be added when picking up the item.")]
        // [SerializeField] protected new ItemCollectionID m_AddToItemCollection = ItemCollectionPurpose.Main;
        // [Tooltip("Fail to pickup the item if the amount added isn't the full amount inside the pickup.")]
        // [SerializeField] protected new bool m_FailIfFullAmountDoesNotFit;
        ...
        public new ItemObject ItemObject => m_ItemObject;
        public new ItemInfo ItemInfo => m_ItemObject.ItemInfo;
        ...
        protected new virtual void UpdateState(ItemObject itemObject)
        {
