...
namespace Opsive.UltimateInventorySystem.Editor.VisualElements
{
    ...
    public class SearchableList<T> : VisualElement where T : class
    {
            ...
            Func<IList<T>, string, IList<T>> searchFilter)
        {
            ...
            AddToClassList(CommonStyles.SearchList);

            var filterPresetContainer = new VisualElement();
            filterPresetContainer.AddToClassList(CommonStyles.SearchList_FilterPresetContainer);
            ...
            m_FilterPresetField.RegisterValueChangedCallback(evt =>
            {
                ...
                SetFilterPreset(filterPreset, true);
            });
            ...
            searchSortContainer.AddToClassList(CommonStyles.SearchList_SearchSortContainer);
            ...
            SetFilterPreset(StoredSearchableListFilterPreset, false);
        }

        private void SetFilterPreset(SearchableListFilterPreset filterPreset, bool refresh)
        {
