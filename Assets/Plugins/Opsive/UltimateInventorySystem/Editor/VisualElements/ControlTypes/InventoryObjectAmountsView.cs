...
namespace Opsive.UltimateInventorySystem.Editor.VisualElements.ControlTypes
{
        ...
        where T : class
    {
        ...
        public event Action<int, Tamount, Tamount> OnChange;
        ...
        public ReorderableList ReorderableList => m_ReorderableList;
        ...
        public void ChangeValue(int index, Tamount objectAmount)
        {
            ...
            var previous = m_ObjectAmounts.Array[index];
            m_ObjectAmounts.Array[index] = objectAmount;
            
            OnChange?.Invoke(index, previous, objectAmount);
