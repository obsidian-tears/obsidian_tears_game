...
namespace Opsive.UltimateInventorySystem.Editor.VisualElements.ControlTypes
{
    ...
    public class UnityObjectFieldWithPreview : ObjectField
    {
        ...
        public UnityObjectFieldWithPreview()
        {
            ...
            m_Preview.AddToClassList(CommonStyles.ObjectPreview);
            m_Preview.AddToClassList(CommonStyles.ObjectPreviewSmall);
            ...
            {
                m_Preview.RemoveFromClassList(CommonStyles.ShrinkZero);
                if (value == null) {
                    m_Preview.AddToClassList(CommonStyles.ShrinkZero);
