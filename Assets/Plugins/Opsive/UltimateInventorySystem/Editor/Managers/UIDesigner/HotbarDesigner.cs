...
namespace Opsive.UltimateInventorySystem.Editor.Managers.UIDesigner
{
        ...
        HotbarDesignerEditor>
    {
        ...
        public override string Description => "Create an Item Hotbar or Inventory Mirror Hotbar where items can be assigned to slots and used.";
    }
    ...
    public class HotbarDesignerCreator : UIDesignerCreator<ItemHotbar>
    {
        ...
        {
            ItemHotbar,
            InventoryMirrorHotbar,
        }
        
        public override string DocumentationURL =>
            "https://opsive.com/support/documentation/ultimate-inventory-system/editor-window/hotbars/";
        public IntegerField m_NumberOfSlots;
        public EnumField m_HotbarTypeField;
        ...
        protected override void CreateOptionsContent(VisualElement container)
        {
            ...
            m_HotbarTypeField = new EnumField("Hotbar Type", HotbarType.ItemHotbar);
            container.Add(m_HotbarTypeField);
        }
        ...
        protected override ItemHotbar BuildInternal()
        {
            ...
            var hotbarType = (HotbarType)m_HotbarTypeField.value;
            if (hotbarType == HotbarType.ItemHotbar) {
                panel = UIDesignerManager.InstantiateSchemaPrefab<DisplayPanel>(UIDesignerSchema.ItemHotbarPanel, rectParent);
            }else if (hotbarType == HotbarType.InventoryMirrorHotbar) {
                panel = UIDesignerManager.InstantiateSchemaPrefab<DisplayPanel>(UIDesignerSchema.InventoryMirrorHotbarPanel, rectParent);
            } else {
                panel = UIDesignerManager.InstantiateSchemaPrefab<DisplayPanel>(UIDesignerSchema.ItemHotbarPanel, rectParent);
            }
