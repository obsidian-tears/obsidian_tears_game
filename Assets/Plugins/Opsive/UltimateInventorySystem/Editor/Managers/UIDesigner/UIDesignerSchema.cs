...
namespace Opsive.UltimateInventorySystem.Editor.Managers.UIDesigner
{
    ...
    public class UIDesignerSchema : ScriptableObject
    {
        ...
        protected (ValidationState validationState, string message) m_ValidationResult = (ValidationState.HasErrors, "Not Yet Checked");
        public (ValidationState validationState, string message) ValidationResult => m_ValidationResult;
        ...
        [SerializeField] protected CategoryItemViewSet m_EquipmentItemViewSet;

        public ItemSlotCollectionView EquipmentItemViewSlotContainer => m_EquipmentItemViewSlotContainer;
        public CategoryItemViewSet EquipmentItemViewSet => m_EquipmentItemViewSet;

        [Header("Item Hotbar")]
        [UIDesignerSchemaValidation(new[] { typeof(ItemHotbar) })]
        [SerializeField] protected DisplayPanel m_ItemHotbarPanel;
        [SerializeField] protected DisplayPanel m_InventoryMirrorHotbarPanel;
        ...
        public DisplayPanel InventoryMirrorHotbarPanel => m_InventoryMirrorHotbarPanel;
        ...
        public (ValidationState validationState, string message) CheckIfValid()
        {
        ...
        private (ValidationState validationState, string message) CheckIfValidInternal()
        {
            var valid = true;
            var message = "";
            ...
            if (valid) {
                return (ValidationState.Valid, message);
            } 
            
            return (ValidationState.HasWarnings, message);
        }
    }
