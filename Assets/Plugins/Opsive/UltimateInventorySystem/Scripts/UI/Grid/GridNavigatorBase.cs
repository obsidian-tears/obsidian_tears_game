...
namespace Opsive.UltimateInventorySystem.UI.Grid
{
    ...
    public class GridNavigatorBase : MonoBehaviour
    {
        ...
        public virtual void Initialize(bool force)
        {
            ...
            m_Grid.OnElementsChanged += HandleElementsChanged;
            m_Grid.OnAfterDraw += HandleAfterDraw;
        ...
        /// <summary>
        /// Update the grid index if the elements have changed.
        /// </summary>
        protected virtual void HandleElementsChanged()
        {
        ...
        /// <summary>
        /// Refresh the Arrows and tab pages after the grid is drawn.
        /// </summary>
        protected virtual void HandleAfterDraw()
        {
            RefreshArrows();
            RefreshTabPages();
        }
        ...
        protected void SetIndexInternal(int newIndex)
        {
            ...
            //No longer needed this is done in the after draw event handler.
            //RefreshArrows();
            //RefreshTabPages();
        }
